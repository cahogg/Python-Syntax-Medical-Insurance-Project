...
print ("This person's cost is ", insurance_cost, "dollars.")
...
print("The change in cost of insurance after increasing the age by 4 years is", change_in_insurance, "dollars.")
...
## Being older and having a higher BMI increase insurance cost. Women also have higher insurance rates than men.
...
new_insurance_cost = 250 * age - 128 * sex + 370 * bmi + 425 * num_of_children + 24000 * smoker - 12500
change_in_insurance_cost = new_insurance_cost - insurance_cost
print ("The change in estimated cost for not having children is", change_in_insurance_cost, "dollars")
